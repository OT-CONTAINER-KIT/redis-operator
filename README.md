[![build status](https://gitlab.com/ot-kubernetes/awesome-operators/redis-operator/badges/master/pipeline.svg)](https://gitlab.com/ot-kubernetes/awesome-operators/redis-operator/12749961/master/)
