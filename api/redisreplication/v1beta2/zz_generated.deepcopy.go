...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RedisReplicationCustomValidator) DeepCopyInto(out *RedisReplicationCustomValidator) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RedisReplicationCustomValidator.
func (in *RedisReplicationCustomValidator) DeepCopy() *RedisReplicationCustomValidator {
	if in == nil {
		return nil
	}
	out := new(RedisReplicationCustomValidator)
	in.DeepCopyInto(out)
	return out
}
