...
func (in *ExistOrGenerateSecrets) DeepCopyInto(out *ExistOrGenerateSecrets) {
	*out = *in
	...
	if in.GeneratePasswordSecret != nil {
		in, out := &in.GeneratePasswordSecret, &out.GeneratePasswordSecret
		*out = new(GeneratePassword)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExistOrGenerateSecrets.
func (in *ExistOrGenerateSecrets) DeepCopy() *ExistOrGenerateSecrets {
	if in == nil {
		return nil
	}
	out := new(ExistOrGenerateSecrets)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KubernetesConfig) DeepCopyInto(out *KubernetesConfig) {
	*out = *in
	...
	if in.ExistOrGenerateSecret != nil {
		in, out := &in.ExistOrGenerateSecret, &out.ExistOrGenerateSecret
		*out = new(ExistOrGenerateSecrets)
		(*in).DeepCopyInto(*out)
	}
