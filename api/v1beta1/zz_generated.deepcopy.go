...
func (in *RedisSentinelSpec) DeepCopyInto(out *RedisSentinelSpec) {
	*out = *in
	...
	if in.RedisSnt != nil {
		in, out := &in.RedisSnt, &out.RedisSnt
		*out = new(RedisSnt)
		(*in).DeepCopyInto(*out)
	}
	if in.Storage != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RedisSnt) DeepCopyInto(out *RedisSnt) {
	*out = *in
	if in.Replicas != nil {
		in, out := &in.Replicas, &out.Replicas
		*out = new(int32)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RedisSnt.
func (in *RedisSnt) DeepCopy() *RedisSnt {
	if in == nil {
		return nil
	}
	out := new(RedisSnt)
