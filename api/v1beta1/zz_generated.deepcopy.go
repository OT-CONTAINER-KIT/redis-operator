...
func (in *RedisSentinelConfig) DeepCopyInto(out *RedisSentinelConfig) {
	*out = *in
	...
	if in.ParallelSyncs != nil {
		in, out := &in.ParallelSyncs, &out.ParallelSyncs
		*out = new(int32)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RedisSentinelSentinel) DeepCopyInto(out *RedisSentinelSentinel) {
	*out = *in
	if in.Replicas != nil {
		in, out := &in.Replicas, &out.Replicas
		*out = new(int32)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RedisSentinelSentinel.
func (in *RedisSentinelSentinel) DeepCopy() *RedisSentinelSentinel {
	if in == nil {
		return nil
	}
	out := new(RedisSentinelSentinel)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RedisSentinelSpec) DeepCopyInto(out *RedisSentinelSpec) {
	*out = *in
	...
	in.KubernetesConfig.DeepCopyInto(&out.KubernetesConfig)
	in.RedisReplica.DeepCopyInto(&out.RedisReplica)
	in.RedisSentinel.DeepCopyInto(&out.RedisSentinel)
	if in.RedisExporter != nil {
		in, out := &in.RedisExporter, &out.RedisExporter
		*out = new(RedisExporter)
		(*in).DeepCopyInto(*out)
