...
func (in *RedisRestoreStatus) DeepCopyInto(out *RedisRestoreStatus) {
	*out = *in
	if in.RestoreCompletedTime != nil {
		in, out := &in.RestoreCompletedTime, &out.RestoreCompletedTime
		*out = (*in).DeepCopy()
	}
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RestoreRollbackState) DeepCopyInto(out *RestoreRollbackState) {
	*out = *in
	if in.StatefulSetReplicas != nil {
		in, out := &in.StatefulSetReplicas, &out.StatefulSetReplicas
		*out = make(map[string]int32, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.SentinelsAnnotated != nil {
		in, out := &in.SentinelsAnnotated, &out.SentinelsAnnotated
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.SentinelReplicas != nil {
		in, out := &in.SentinelReplicas, &out.SentinelReplicas
		*out = make(map[string]int32, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RestoreRollbackState.
func (in *RestoreRollbackState) DeepCopy() *RestoreRollbackState {
	if in == nil {
		return nil
	}
	out := new(RestoreRollbackState)
