...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExistingAuthSecret) DeepCopyInto(out *ExistingAuthSecret) {
	*out = *in
	if in.Name != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExistingAuthSecret.
func (in *ExistingAuthSecret) DeepCopy() *ExistingAuthSecret {
	if in == nil {
		return nil
	}
	out := new(ExistingAuthSecret)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KubernetesConfig) DeepCopyInto(out *KubernetesConfig) {
	*out = *in
	...
	if in.ExistingAuthSecret != nil {
		in, out := &in.ExistingAuthSecret, &out.ExistingAuthSecret
		*out = new(ExistingAuthSecret)
		(*in).DeepCopyInto(*out)
	}
