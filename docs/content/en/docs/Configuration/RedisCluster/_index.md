...
| redisCluster.maxMemoryPercentOfLimit | int | `0` | Sets Redis maxmemory as a percentage of container memory limit |
| redisCluster.memoryPolicy | string | `` | Sets the redis maxmemoyr-policy which controls how keys are evicted |
